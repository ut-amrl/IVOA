...
"cra_full_train_model_unlocked_continued_best_model_016.pt" \
 --save_dir "/data/CAML/IVOA_CRA/evaluation_multi_class/unlocked_continued_best_16_embeddings/" \
 --result_file_name  evaluation_unlocked_continued_r \
